...
selected_descriptors = "Px_label_short" # Options: "Px", "Py", "Pxy", "Px_cond", "Pxy_cond", "Px_label_long", "Px_label_short" for training time
...
# args = {
#     'random_mode':True,
#     'mixing_label_number':3, # was 3 for new_config
