...
axes[0,0].plot(x, zzz_m_k, label="Ours", color="blue", marker='o', markersize=2)
axes[0,0].plot(x, zzz_m_k_p, label="Ours (prior)", color="black", marker='o', markersize=2)
...
axes[0,1].plot(x, zzz_f_k, label="Ours", color="blue", marker='o', markersize=2)
axes[0,1].plot(x, zzz_f_k_p, label="Ours (prior)", color="black", marker='o', markersize=2)
...
axes[0,2].plot(x, zzz_c_k, label="Ours", color="blue", marker='o', markersize=2)
axes[0,2].plot(x, zzz_c_k_p, label="Ours (prior)", color="black", marker='o', markersize=2)
...
axes[1,0].plot(x, zzz_m_t, label="Ours", color="blue", marker='o', markersize=2)
axes[1,0].plot(x, zzz_m_t_p, label="Ours (prior)", color="black", marker='o', markersize=2)
axes[1,0].set_xlabel("Heterogeneity Level")
axes[1,0].set_ylabel("Accuracy (Real Testing Phase)")
...
axes[1,2].plot(x, zzz_c_t, label="Ours", color="blue", marker='o', markersize=2)
axes[1,2].plot(x, zzz_c_t_p, label="Ours (prior)", color="black", marker='o', markersize=2)
axes[1,2].set_xlabel("Heterogeneity Level")
axes[1,2].set_ylabel("Accuracy (Real Testing Phase)")
