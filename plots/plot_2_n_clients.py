...
axes[0].plot(x, zzz_no, label="Ours", color="blue", marker='o', markersize=2)
axes[0].plot(x, zzz_no_p, label="Ours (prior)", color="black", marker='o', markersize=2)
...
axes[1].plot(x, zzz, label="Ours", color="blue", marker='o', markersize=2)
axes[1].plot(x, zzz_p, label="Ours (prior)", color="black", marker='o', markersize=2)
